...
bool init(){
    ...
    window = SDL_CreateWindow("O AN QUAN", SDL_WINDOWPOS_UNDEFINED,
    ...
    loadBackground("img/bkground.png");
    return true;
}
...
void ketQua(Cell A, Cell B, Cell *cell){
    if( A.value + cell[1].value +cell[2].value + cell[3].value + cell[4].value + cell[5].value
        ...
        loadBackground("img/hoa.png");
        return;
    } else {
        if( A.value + cell[1].value +cell[2].value + cell[3].value + cell[4].value + cell[5].value
            > B.value + cell[7].value + cell[8].value+ cell[9].value + cell[10].value + cell[11].value){
            loadBackground("img/aThang.png");
            return;
        } else
        {
            loadBackground("img/bThang.png");
            return;
        }
    }
}
